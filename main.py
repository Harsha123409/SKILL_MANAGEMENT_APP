...
#     email: str = Form(...),
#     password: str = Form(...),
#     role: str = Form("Employee"),  # Default role is "Employee"
#     db: Session = Depends(get_db)
# ):
#     user = schemas.UserCreate(name=name, email=email, password=password, role=role)
#     crud.create_user(db, user)
...
#         "request": request,
#         "skills": approved_skills,
#         "users": users  # Needed for employee dropdown
#     })
...
#     if skill and employee:
#         # Create the project and link the skill and employee
#         project = models.Project(
#             name=project_name,
#             skill_id=skill.id,  # Link to the Skill object
...
#         db.refresh(project)
#     else:
#         raise ValueError("Invalid skill or employee.")
...
# @app.get("/projects/view", response_class=HTMLResponse)
# def view_projects(request: Request, db: Session = Depends(get_db)):
#     # Use joinedload to eagerly load the skill and employee relationships
#     projects = db.query(models.Project).options(
#         joinedload(models.Project.skill),
#         joinedload(models.Project.employee)
#     ).all()
